...
exports.showSingleYazi = async (req, res, next) => {
  try {
    const post = await Post.findById(req.params.id).populate(
      "comments.postedBy",
      "name"
...
exports.showSiirler = async (req, res, next) => {
  try {
...
exports.showSingleSiir = async (req, res, next) => {
  try {
    const post = await Post.findById(req.params.id).populate(
      "comments.postedBy",
      "name"
...
exports.showMakaleler = async (req, res, next) => {
  try {
...
exports.showSingleMakale = async (req, res, next) => {
  try {
    const post = await Post.findById(req.params.id).populate(
      "comments.postedBy",
      "name"
...
exports.showGundemeDair = async (req, res, next) => {
  try {
...
exports.showSingleGundemeDair = async (req, res, next) => {
  try {
    const post = await Post.findById(req.params.id).populate(
      "comments.postedBy",
      "name"
